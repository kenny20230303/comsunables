  ...
  <div style="display: flex; flex-direction: column; height: 100vh;">
    ...
    <el-card class="user-card" style="flex: 1; display: flex; flex-direction: column; overflow: auto;">
      ...
      >
        ...
        <el-table-column prop="UserDepartment_name" label="用户类型"></el-table-column>
...
export default {
  data() {
    return {
      users: [],
      dialogVisible: false,
      currentUser: {id: null, username: '', name: '', phone: '', user_type: '', UserDepartment_name: ''},
      usertype: 'auditor',
      UserDepartment: '',
    };
  },
  ...
  methods: {
    ...
    openDialog() {
      this.currentUser = {id: null, username: '', name: '', phone: '', user_type: 'auditor', UserDepartment_name: ''};
